...
# This script will run when STARTING the project "nb"
...
cd $HOME/code/magref-notebooks

source activate thermo && osascript "$PRM_DIR/$PRM_ACTIVE_PROJECT/item-tab-jupyter.applescript"
