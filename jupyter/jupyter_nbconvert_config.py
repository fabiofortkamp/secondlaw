...
JUPYTER_PATH = Path(os.getenv("JUPYTER_CONFIG_DIR"))
...
## 
#c.ExtractOutputPreprocessor.extract_output_types = {'application/pdf', 'image/svg+xml', 'image/jpeg', 'image/png'}
